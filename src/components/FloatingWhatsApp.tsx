...
export function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className={`fixed z-50 bottom-5 right-5 md:bottom-7 md:right-7 group flex items-center gap-3 transition-all duration-500 ${
        visible
    ...
    >
      ...
      <span className="relative flex items-center justify-center w-14 h-14 md:w-15 md:h-15 rounded-full bg-accent text-accent-foreground shadow-[0_10px_30px_-8px_rgba(0,0,0,0.6)] hover:scale-105 transition-transform duration-500">
